...
export class ExtensionRunner {
	...
	bindCore(
		...
		this.runtime.getSessionState = actions.getSessionState;
		this.runtime.setSessionState = actions.setSessionState;
	...
	setUIContext(uiContext?: ExtensionUIContext, mode: ExtensionMode = "print"): void {
		// Keep the exported no-UI context (rpc-mode injects it directly) but wrap
		// real contexts so UI prompt events fire around every dialog call.
		this.uiContext = uiContext ? this.wrapUIPromptContext(uiContext) : noOpExtensionUIContext;
		this.mode = mode;
	}
