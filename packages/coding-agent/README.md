...
| Ctrl+C | Clear editor |
| Ctrl+C twice | Quit |
| Escape | Pause after current tool calls finish; again while paused: continue |
| Ctrl+Escape or Ctrl+\\ | Abort now (interrupt stream and tools) |
| Escape twice | Open `/tree` |
| Ctrl+L | Open model selector |
| Ctrl+P / Shift+Ctrl+P | Cycle scoped models forward/backward |
| Ctrl+T / Ctrl+Alt+T | Cycle thinking level forward/backward |
| Ctrl+O | Collapse/expand tool output |
| Ctrl+H | Collapse/expand thinking blocks |
...
- **Escape** pauses the turn at the next boundary: running tools finish, but the next model request is held. Type a message and it becomes the continuation; press Escape again to continue without one. Pressing Escape twice before the pause lands cancels it. Queued messages are restored to the editor.
- **Ctrl+Escape** aborts hard, interrupting the stream and running tools
