...
describe("StdinBuffer", () => {
	...
	describe("Partial Escape Sequences", () => {
		...
		it("should flush a lone ESC separately when CR arrives after the timeout", async () => {
			// Once ESC has timed out, a later byte must remain separate instead of being retroactively joined to an already-dispatched sequence.
			processInput("\x1b");
